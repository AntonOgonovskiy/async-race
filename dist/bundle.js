...
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {\n__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"carUpdater\": () => (/* binding */ carUpdater),\n/* harmony export */   \"engine\": () => (/* binding */ engine),\n/* harmony export */   \"racing\": () => (/* binding */ racing)\n/* harmony export */ });\n/* harmony import */ var _model_carsDrivers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../model/carsDrivers */ \"./src/model/carsDrivers.ts\");\n/* harmony import */ var _model_carsGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../model/carsGenerator */ \"./src/model/carsGenerator.ts\");\n/* harmony import */ var _view_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../view/view */ \"./src/view/view.ts\");\n/* harmony import */ var _api_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../api/api */ \"./src/controller/api/api.ts\");\nvar __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_model_carsDrivers__WEBPACK_IMPORTED_MODULE_0__, _model_carsGenerator__WEBPACK_IMPORTED_MODULE_1__, _view_view__WEBPACK_IMPORTED_MODULE_2__]);\n([_model_carsDrivers__WEBPACK_IMPORTED_MODULE_0__, _model_carsGenerator__WEBPACK_IMPORTED_MODULE_1__, _view_view__WEBPACK_IMPORTED_MODULE_2__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);\n\r\n\r\n\r\n\r\nconst engine = () => {\r\n    document.addEventListener('click', (event) => {\r\n        const target = event.target;\r\n        if (target?.classList.contains(\"start-engine-btn\")) {\r\n            const id = +target.id.split(\"start-engine-car-\")[1];\r\n            (0,_model_carsDrivers__WEBPACK_IMPORTED_MODULE_0__.startDrive)(id);\r\n        }\r\n        if (target?.classList.contains(\"stop-engine-btn\")) {\r\n            const id = +target.id.split(\"stop-engine-car-\")[1];\r\n            (0,_model_carsDrivers__WEBPACK_IMPORTED_MODULE_0__.stopDrive)(id);\r\n        }\r\n    });\r\n};\r\nconst racing = () => {\r\n    document.addEventListener('click', (event) => {\r\n        const target = event.target;\r\n        if (target?.classList.contains(\"race-btn\")) {\r\n            (0,_model_carsDrivers__WEBPACK_IMPORTED_MODULE_0__.race)(_model_carsDrivers__WEBPACK_IMPORTED_MODULE_0__.startDrive);\r\n        }\r\n        if (target?.classList.contains(\"stop-race-btn\")) {\r\n            (0,_model_carsDrivers__WEBPACK_IMPORTED_MODULE_0__.stopRace)();\r\n        }\r\n    });\r\n};\r\nconst carUpdater = () => {\r\n    document.addEventListener('click', async (event) => {\r\n        const target = event.target;\r\n        const div = document.querySelector('.cars');\r\n        if (target?.classList.contains(\"create-car\")) {\r\n            (0,_model_carsGenerator__WEBPACK_IMPORTED_MODULE_1__.makeCar)();\r\n        }\r\n        if (target?.classList.contains(\"remove-car-button\")) {\r\n            const id = +target.id.split(\"remove-car-\")[1];\r\n            await (0,_api_api__WEBPACK_IMPORTED_MODULE_3__.deleteCar)(id);\r\n            await (0,_api_api__WEBPACK_IMPORTED_MODULE_3__.deleteWinner)(id);\r\n            await (0,_model_carsGenerator__WEBPACK_IMPORTED_MODULE_1__.updateCarStorage)();\r\n            if (div)\r\n                div.innerHTML = (0,_view_view__WEBPACK_IMPORTED_MODULE_2__.renderGarage)();\r\n        }\r\n        if (target?.classList.contains(\"list-car\")) {\r\n            await (0,_model_carsGenerator__WEBPACK_IMPORTED_MODULE_1__.makeArrOfCars)();\r\n            await (0,_model_carsGenerator__WEBPACK_IMPORTED_MODULE_1__.updateCarStorage)();\r\n            if (div)\r\n                div.innerHTML = (0,_view_view__WEBPACK_IMPORTED_MODULE_2__.renderGarage)();\r\n        }\r\n        if (target?.classList.contains(\"update-car-button\")) {\r\n            const id = +target.id.split(\"update-car-\")[1];\r\n            (0,_model_carsGenerator__WEBPACK_IMPORTED_MODULE_1__.selectCar)(id);\r\n        }\r\n        if (target?.classList.contains(\"update-car\")) {\r\n            console.log('hi');\r\n            await (0,_model_carsGenerator__WEBPACK_IMPORTED_MODULE_1__.changeCar)();\r\n            await (0,_model_carsGenerator__WEBPACK_IMPORTED_MODULE_1__.updateCarStorage)();\r\n            if (div)\r\n                div.innerHTML = (0,_view_view__WEBPACK_IMPORTED_MODULE_2__.renderGarage)();\r\n        }\r\n    });\r\n};\r\n\n__webpack_async_result__();\n} catch(e) { __webpack_async_result__(e); } });\n\n//# sourceURL=webpack://async-race-api/./src/controller/listeners/listeners.ts?");
...
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {\n__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _view_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view/view */ \"./src/view/view.ts\");\n/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/style.css */ \"./src/styles/style.css\");\n/* harmony import */ var _controller_listeners_listeners__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controller/listeners/listeners */ \"./src/controller/listeners/listeners.ts\");\nvar __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_view_view__WEBPACK_IMPORTED_MODULE_0__, _controller_listeners_listeners__WEBPACK_IMPORTED_MODULE_2__]);\n([_view_view__WEBPACK_IMPORTED_MODULE_0__, _controller_listeners_listeners__WEBPACK_IMPORTED_MODULE_2__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);\n\r\n\r\n\r\n(0,_view_view__WEBPACK_IMPORTED_MODULE_0__.renderPage)();\r\n_controller_listeners_listeners__WEBPACK_IMPORTED_MODULE_2__.engine();\r\n_controller_listeners_listeners__WEBPACK_IMPORTED_MODULE_2__.racing();\r\n_controller_listeners_listeners__WEBPACK_IMPORTED_MODULE_2__.carUpdater();\r\n\n__webpack_async_result__();\n} catch(e) { __webpack_async_result__(e); } });\n\n//# sourceURL=webpack://async-race-api/./src/index.ts?");
